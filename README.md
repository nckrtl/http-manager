...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/http-manager.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/http-manager)
...
```bash
php artisan vendor:publish --tag="http-manager-views"
```

## Usage

```php
$httpManager = new NckRtl\HttpManager();
echo $httpManager->echoPhrase('Hello, NckRtl!');
```
